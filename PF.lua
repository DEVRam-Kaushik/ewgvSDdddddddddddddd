...
-- Rapid Fire
-- Anti Recoil
-- silent aim only fov circle
-- make pistol have dot
-- All Attachments for guns (client sided)
-- select bodypart
...
v3:GetPropertyChangedSignal("ViewportSize"):Connect(
    function()
        v21.Position = Vector2.new(v3.ViewportSize.X / 2, v3.ViewportSize.Y / 2)
    end
)
...
local function v33(v112)
    ...
    local v114 =
        v112:FindFirstChildWhichIsA("Folder") and
        v112:FindFirstChildWhichIsA("Folder"):FindFirstChildOfClass("MeshPart")
    if not v114 then
        return false
    end
...
local v48 = loadstring(game:HttpGet("https://raw.githubusercontent.com/AlterX404/Alter_Hub/refs/heads/main/tspmo.lua"))
...
v55:bindToEvent(
    ...
    function(v140)
        ...
        if is_aimbot_enabled then
            input_began_connection =
                v4.InputBegan:Connect(
                function(v240)
            ...
            input_ended_connection =
                v4.InputEnded:Connect(
                function(v241)
            ...
            render_stepped_connection =
                v0.RenderStepped:Connect(
                function()
                    if (v17 and v18) then
        ...
        if v216.features then
            v31 = {
                ...
                distance_text = {
                    color = Color3.new(
                        unpack(
                            v216.features.distance_text.color or
                                {
                                    1,
                                    1,
                                    1
                ...
                head_dot = {
                    color = Color3.new(
                        unpack(
                            v216.features.head_dot.color or
                                {
                                    1,
                                    1,
                                    1
...
local function v106()
    ...
    v165:GetPropertyChangedSignal("Visible"):Connect(
        function()
                            ...
                            if (v263 and v264) then
                                ...
                                if v266 then
                                    ...
                                    if (not v79:getState() or (v270 <= v21.Radius)) then
                                        ...
                                        local v273 =
                                            ((1000 / (v3.CFrame.Position - v263.Position).Magnitude) * 80) /
                                            v3.FieldOfView
                                        ...
                                        if v68:getState() then
                                            ...
                                            v254.name_label.Position =
                                                v29(
                                                v254.box_square.Position.X + (v254.box_square.Size.X / 2),
                                                v254.box_square.Position.Y - 30
                                            )
                                        else
                                        ...
                                        if v67:getState() then
                                            ...
                                            v254.distance_label.Position =
                                                v29(
                                                v254.box_square.Position.X + (v254.box_square.Size.X / 2),
                                                v254.box_square.Position.Y - 15
                                            )
                                        else
...
while v109 do
    ...
    if v186 then
        v186.JumpPower = v100
        v186:GetPropertyChangedSignal("WalkSpeed"):Connect(
            function()
                v186.JumpPower = v100
            end
        )

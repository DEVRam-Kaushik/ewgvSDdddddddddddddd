	...
	if game.PlaceId == 2753915549 then
		...
		-- print("--------------------------------------------------------------------------");
		local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/AlterX404/Alter_Hub/refs/heads/main/bfs.lua")))();
		...
		(getgenv()).Load = function()
			if readfile and writefile and isfile and isfolder then
				if not isfolder("AlterHub") then
					makefolder("AlterHub");
				end;
				if not isfolder("AlterHub/Blox Fruits/") then
					makefolder("AlterHub/Blox Fruits/");
				end;
				if not isfile(("AlterHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
					writefile("AlterHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
				else
					local Decode = (game:GetService("HttpService")):JSONDecode(readfile("AlterHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
			...
			if Update:SaveSettings() then
				if readfile and writefile and isfile and isfolder then
					if not isfile(("AlterHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
						...
						writefile("AlterHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
					end;
				else
					return warn("Status : Undetected Executor");
				end;
		...
		MainTab:Button("Copy Discord Link", function()
			setclipboard("https://discord.gg/nccenRYyQ4");
		...
		if World2 or World3 then
			...
			for i, v in pairs({"Flame", "Ice", "Quake", "Light", "Dark", "Spider", "Rumble", "Magma", "Buddha", "Sand"}) do
				table.insert(Raidslist, v);
			end;
			for i, v in pairs({"Phoenix", "Dough"}) do
				table.insert(Raidslist, v);
			end;
